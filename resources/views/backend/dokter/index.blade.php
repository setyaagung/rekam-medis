                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('dokter.create')}}" class="btn btn-primary btn-sm float-right">Tambah</a>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($dokters as $dokter)
                                        <tr>
                                            ...
                                            <td>{{ $dokter->alamat}}</td>
                                            <td>
                                                <a href="{{ route('dokter.edit',$dokter->id_dokter)}}" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i> Edit</a>
