                        ...
                        <div class="card-body">
                            <form action="{{ route('dokter.store')}}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="nama_dokter" type="text" class="form-control @error('nama_dokter') is-invalid @enderror" name="nama_dokter" value="{{ old('nama_dokter') }}" required autocomplete="nama_dokter">
                                    @error('nama_dokter')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
