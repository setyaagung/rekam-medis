...
<html lang="en">
    <head>
        ...
        <title>RIWAYAT PEMERIKSAAN {{$taruna->nama_taruna}}</title>
        <!-- Theme style -->
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
    </head>
    <body>
        <p class="text-center font-weight-bold" style="font-size: 13px">
        ...
        <p class="text-center" style="font-size: 11px;margin-top: -10px">
            Jl. Singosari Raya No.2A, Wonodri 50242 Telp. (62) 024 8311527 Fax. (62) 024 8311529
            <br>
            Website : www.pip-semarang.ac.id&nbsp;&nbsp;&nbsp;&nbsp;E-mail : info@pip-semarang.ac.id
        </p>
        ...
        @if ($rm)
            ...
            <h5 class="text-center font-weight-bold mt-4">
                <u>CATATAN REKAM MEDIS</u>
            </h5>
            <p class="text-center" style="margin-top: -14px">Nomor:{{ $rm->no_rm}}</p>
            <div class="data" style="font-size: 14px" style="width: 100%">
                <div class="row">
                    <div class="col-md-12">
            ...
            <div class="fisik" style="font-size: 12px">
                <div class="row">
                    <div class="col-md-12">
            ...
            <div class="tht" style="font-size: 12px">
                <div class="row">
                    <div class="col-md-12">
                        <h6 class="font-weight-bold text-primary">
                            Pemeriksaan THT*
            ...
            <div class="mata" style="font-size: 12px">
                <div class="row">
                    <div class="col-md-12">
                        <h6 class="font-weight-bold text-primary">
                            Pemeriksaan Mata*
            ...
            <div class="gigi" style="font-size: 12px">
                <div class="row">
                    <div class="col-md-12">
                        <h6 class="font-weight-bold text-primary">
                            Pemeriksaan Gigi*
            ...
            <div class="reproduksi" style="font-size: 12px">
                <div class="row">
                    <div class="col-md-12">
                        <h6 class="font-weight-bold text-primary">
            ...
            <div class="lab" style="font-size: 12px">
                <div class="row">
                    <div class="col-md-12">
                        <h6 class="font-weight-bold text-primary">
                            Laboratorium*
            ...
            <div class="umum" style="font-size: 12px">
                <div class="row">
                    <div class="col-md-12">
                        <h6 class="font-weight-bold text-primary">
                            Pemeriksaan Umum*
