                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('jurusan.create')}}" class="btn btn-primary btn-sm float-right">Tambah</a>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($jurusans as $jurusan)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('jurusan.edit',$jurusan->id_jurusan)}}" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i> Edit</a>
