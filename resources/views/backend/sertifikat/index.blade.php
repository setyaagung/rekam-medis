                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('sertifikat.create')}}" class="btn btn-primary btn-sm float-right">Tambah</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    @foreach ($sertifikats as $sertifikat)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('sertifikat.destroy',$sertifikat->id_sertifikat)}}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
